      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="text-white/60 text-sm md:text-base">
            Phases and key dates merged into an integrated timeline. Follow the
            roadmap from online registration to the intense physical finale in
            Chennai.
          </p>
        </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-6 liquid-glass rounded-2xl p-6 border border-white/5 hover:border-brand-pink/20 transition-all duration-300">
                <span className="text-[10px] uppercase font-mono tracking-widest text-purple-400 font-bold block mb-4">
                  Phase 1 Checklist
                </span>
                <div className="space-y-4">
                  <div className="flex gap-3 items-start">
                    <span className="h-5 w-5 rounded-full bg-brand-pink/10 border border-brand-pink/30 text-purple-400 text-xs font-mono font-bold flex items-center justify-center shrink-0 mt-0.5">
                      ✓
                    </span>
                    <p className="text-xs text-white/80">
                      <strong>Choose an SDG Theme:</strong> Select from any one
                      of the SDGs.
                    </p>
                  </div>
                  <div className="flex gap-3 items-start">
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    <p className="text-xs text-white/80">
                      <strong>Official Devfolio submission:</strong> Upload
                      concept pitches before the registrations deadline closes.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-6 space-y-4">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  The Top 50 shortlisted teams gather at Rajalakshmi Engineering
                  College campus, Chennai, to build in-person under
                  code-intensive, high-adrenaline conditions.
                </p>
              ...
              <div className="lg:col-span-6 liquid-glass rounded-2xl p-6 border-2 border-brand-pink/30 bg-gradient-to-br from-brand-pink/10 to-black neon-glow-pink hover:border-brand-pink/50 transition-all duration-300">
                ...
                <div className="space-y-4">
                  <div className="flex gap-3 items-start">
                    <span className="h-5 w-5 rounded-full bg-brand-pink/20 border border-brand-pink/40 text-purple-400 text-xs font-mono font-bold flex items-center justify-center shrink-0 mt-0.5">
                      ✓
                    </span>
                    <p className="text-xs text-white/80">
                      <strong>On-Spot Problems:</strong> Receive exclusive
                      real-time challenge briefs at kickoff!
                    </p>
                  </div>
                  <div className="flex gap-3 items-start">
                    <span className="h-5 w-5 rounded-full bg-brand-pink/20 border border-brand-pink/40 text-brand-pink text-xs font-mono font-bold flex items-center justify-center shrink-0 mt-0.5">
                      ✓
                    </span>
                    <p className="text-xs text-white/80">
                      <strong>Mentorship:</strong> Complete prototype coding
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    <p className="text-xs text-white/80">
                      <strong>Pitch to Jury:</strong> Present functional
                      software on stage to earn rewards.
                    </p>
                  </div>
                </div>
              </div>
