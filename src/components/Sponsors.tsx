      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="border-t border-white/5 pt-12 mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/happyfox_logo.png" alt="HappyFox logo" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/Eleven_labs.jpg" alt="ElevenLabs logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/notion_logo.png" alt="Notion logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/.xyz.jpg" alt="XYZ logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/Balsamiq.png" alt="Balsamiq logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/interviewbuddy.png" alt="Interview Buddy logo placeholder" className="h-full w-full object-contain" />
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 mt-6">
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/mastra.png" alt="Mastra logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/mako.webp" alt="Mako IT logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/interviewcake.png" alt="Interview Cake logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/wyntrixlogo.jpeg" alt="Wyntrix logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/navan_ai_logo.jpeg" alt="Navan logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/yuniqlogo.jpeg" alt="Yuniq logo placeholder" className="h-full w-full object-contain" />
              </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-6">
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 w-[200px] hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/oostudios.jpeg" alt="Elite sponsor logo placeholder" className="h-full w-full object-contain" />
              </div>
            ...
            <motion.div whileHover={{ y: -4 }} className="liquid-glass rounded-xl p-4 flex flex-col items-center justify-center text-center h-36 w-[200px] hover:border-brand-pink/30 transition-all">
              <div className="h-20 w-20 rounded-2xl overflow-hidden border border-white/10 bg-black/30 flex items-center justify-center mb-4">
                <img src="/src/assets/images/grogoot.jpg" alt="Elite sponsor logo placeholder" className="h-full w-full object-contain" />
              </div>
        ...
        >
          <div>
            <span className="text-[10px] uppercase tracking-[0.25em] text-brand-pink font-extrabold bg-white/5 border border-brand-pink/20 rounded-full px-3 py-1.5 inline-block mb-4">
              Become a Sponsor
            </span>
